...
class MyContents  {
    ...
    */ 
    ...
    init() {
        ...
        const pointLight = new THREE.PointLight( 0xffffff, 5, 15, 0); // a light of color 0x0000ff, intensity 200, maximum range 0 (infinite), affects the colors reflected on the planes and their intensity
        pointLight.position.set( 0, 6, 0 ); // changes the position o the light, notable for affecting the apparent intensity of the light on the planes, as it is nearer or further
